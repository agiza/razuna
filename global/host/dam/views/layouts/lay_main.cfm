...
<!--- CSS --->
<link rel="stylesheet" type="text/css" href="#dynpath#/global/js/jquery-ui-1.10.3.custom/css/ui-lightness/jquery-ui-1.10.3.custom.css?_v=#attributes.cachetag#" />
...
<!--- JS --->
<script type="text/javascript" src="#dynpath#/global/js/jquery-1.9.1.js?_v=#attributes.cachetag#"></script>
...
<script type="text/javascript" src="#dynpath#/global/js/jquery-ui-1.10.3.custom/js/jquery-ui-1.10.3.custom.js?_v=#attributes.cachetag#"></script>
...
<script type="text/javascript" src="#dynpath#/global/js/jstree/_lib/jquery.cookie.js?_v=#attributes.cachetag#"></script>
<script type="text/javascript" src="#dynpath#/global/host/dam/js/global.js?_v=#attributes.cachetag#"></script>
<script type="text/javascript" src="#dynpath#/global/js/jstree/jquery.jstree.js?_v=#attributes.cachetag#"></script>
